# Geometric Langlands — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/geometric-langlands-canonical-lane-mathlib.git
cd geometric-langlands-canonical-lane-mathlib
lake exe
lake build
```
